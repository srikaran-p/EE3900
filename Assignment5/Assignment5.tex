...
\begin{align}
    ...
    &= -71
\end{align}
Since $D < 0$, the equation has no real roots. From the figure, we can see that the function does not cross the x-axis, so, the quadratic equation has no real roots.
\begin{figure}[htp]
    \centering
